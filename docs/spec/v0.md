...
(`set`, `null`, and `float` became keywords in July 2026 — a
source-level break for programs that used them as identifiers. The §6
...
open tier by decision (§8) — `GET /~contract` exposes it.
